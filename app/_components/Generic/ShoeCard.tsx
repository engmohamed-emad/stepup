 ...
 originalprice,
  ...
  return (
    <div className="w-full rounded-[20px] bg-[#D9D9D9]/15 p-4 border border-[#D9D9D9] shadow-sm">
      {/* Image area */}
      <div className="flex h-44 lg:h-50 items-center justify-center">
        <img
          src={img}
          alt={name}
      ...
      <div className="mt-4 mb-3 flex items-end justify-between px-1">
        <div className="flex flex-col gap-1">
          <p className="text-[15px] font-medium leading-tight text-gray-900 truncate max-w-[140px]">
            {name}
          </p>
        ...
        <ArrowButton onArrowClick={onArrowClick} description='View Details' />
      </div>
    </div>
  );
}